...
print('   ###config###',EYECATCH,'--------------------------------------------------')
print('   ###config###',EYECATCH,'### MAIL_SENDER =',MAIL_SENDER)
print('   ###config###',EYECATCH,'### MAIL_SUBJECT_PREFIX =',MAIL_SUBJECT_PREFIX)
print('   ###config###',EYECATCH,'### MAIL_DEFAULT_SENDER =',MAIL_DEFAULT_SENDER)
print('   ###config###',EYECATCH,'### MAIL_ADMIN_SENDER =',MAIL_ADMIN_SENDER)
print('   ###config###',EYECATCH,'### MAIL_SUPPORT_SENDER =',MAIL_SUPPORT_SENDER)
print('   ###config###',EYECATCH,'### WEBSITE_ADMIN =',WEBSITE_ADMIN)
print('   ###config###',EYECATCH,'--------------------------------------------------')
