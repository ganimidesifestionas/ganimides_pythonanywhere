...
if EXECUTION_ENVIRONMENT=='pythonanywhere':
    ...
    os.environ["SQLALCHEMY_DATABASE_URI"] = 'mysql+pymysql://ganimides:philea13@ganimides.mysql.pythonanywhere-services.com/ganimides$ganimides_db'
else:
    ...
    os.environ["SQLALCHEMY_DATABASE_URI"] = 'mysql+pymysql://ganimedes:philea13@localhost/ganimedes_db'
################################################################
